...
function exampleTask(taskNumber) {
    return new Promise(function (resolve) {
        setTimeout(function () {
            console.log("exampleTask".concat(taskNumber, " \uC644\uB8CC"));
            resolve("\uACB0\uACFC ".concat(taskNumber));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    //await new Promise((resolve) => setImmediate(resolve));
                    _a.sent();
                    console.log("setImmediate \uD6C4 Task ".concat(i + 1, "\uB85C \uC774\uB3D9"));
                    _a.label = 4;
                case 4:
                    i++;
                    return [3 /*break*/, 1];
...
runTasksSequentially().then(function () { return console.log("모든 비동기 작업 완료"); });
