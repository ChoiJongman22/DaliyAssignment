...
//     reconcile():void{
//         let from:string =(this.getRandomElement(this.fightList)).from;
//         let to:string = (this.getRandomElement(this.fightList)).to;
//         const fidx=this.playerList.findIndex(player =>player.name===from);
//         const tidx=this.playerList.findIndex(player =>player.name === to);
//         if(fidx!==-1 && tidx !==-1){
...
//             else{
//                 this.playerList.splice(fidx,1);
//                 const idx=this.fightList.findIndex(player =>player.from===from);
//                 const idx2=this.fightList.findIndex(player =>player.to===to);
