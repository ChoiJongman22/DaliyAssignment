...
var InfinityChallenge = /** @class */ (function () {
    ...
    InfinityChallenge.prototype.saveEpisode = function () {
        return __awaiter(this, void 0, void 0, function () {
            var name, year, time, rate, order, minor, lowestRateIndex, order_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        time = _a.sent();
                        return [4 /*yield*/, this.askEpisode("에피소드 시청률을 작성해주세요.")];
                    case 4:
                        rate = _a.sent();
                        order = this.episode.length + 1;
                        if (order === 21) {
                            minor = 0;
                            lowestRateIndex = this.episode.reduce(function (lowest, episode, index) {
                                return episode.rate < _this.episode[lowest].rate ? index : lowest;
                            }, 0);
                            this.episode.splice(lowestRateIndex, 1);
                            order_1 = this.episode.length;
                            this.episode.push({ order: order_1, name: name, time: time, year: year, rate: rate });
                        }
                        else {
                            this.episode.push({ order: order, name: name, time: time, year: year, rate: rate });
                        }
                        return [2 /*return*/];
                }
            });
    ...
    InfinityChallenge.prototype.modifyEpisode = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.askEpisode("타겟 에피소드 이름을 작성하세요.")];
                    case 1:
                        targetEP = _b.sent();
    ...
    InfinityChallenge.prototype.watchIC = function (duration, idx) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        console.log(duration, "분만 봐야돼 너!");
                        console.log(_this.episode[idx].name, "방영 중");
                        var episodeIdx = idx;
                        var seconds = 0;
                        var second = 0;
                        var intervalId = setInterval(function () {
                            if (_this.episode[episodeIdx].time <= second) {
                                episodeIdx++;
                                console.log(_this.episode[episodeIdx].name, "방영 중");
                                console.log("아 재밌어.");
                                second = 0;
                            }
                            else {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    IC.getStatus();
                    return [4 /*yield*/, IC.watchIC(10, 0)];
                case 4:
                    _a.sent();
